...
class InvalidPaymentInformation extends Component {
  render() {
          ...
          <Grid item xs={12} sm={12} md={6} lg={6}>
            <Paper elevation={10}>
              <Grid container direction={'column'} alignItems={'center'} justify={'center'} spacing={24}>
                ...
                <Grid item xs={12}>
                  <Typography>اطلاعات ارسالی نا معتبر هستند!</Typography>
                </Grid>
                <Grid item xs={12}>
...
export default withStyles(style)(InvalidPaymentInformation);
